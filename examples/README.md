...
| `business_diagnostic_demo.py` | `monitoring/business_diagnostic` | Local execute | `[monitoring_business_diagnostic]` | None | Offline scenario ledger demo: adjudicate the in-bundle framework against an observation, calibrate against a resolved outcome, and one fail-closed contract error. |
